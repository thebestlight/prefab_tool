...
- **Source-Available**: Source code is published for transparency.
- **Noncommercial Use Only**: Free for personal, educational, and noncommercial purposes.
- **No Distribution/Modification**: You may **not** distribute copies or make changes.
- **Commercial Use**: Requires a separate written agreement.

For full terms, see the [LICENSE](LICENSE) file or visit https://polyformproject.org/licenses/strict/1.0.0
# SPDX-License-Identifier: PolyForm-Strict-1.0.0
# Copyright © 2026 [The Best Light]
